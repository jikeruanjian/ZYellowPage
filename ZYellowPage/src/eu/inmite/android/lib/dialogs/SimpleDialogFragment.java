...
public class SimpleDialogFragment extends BaseDialogFragment {
	...
	private ISimpleDialogListener simpleDialogListener;

	private ISimpleDialogCancelListener simpleDialogCancelListener;

	public void setSimpleDialogListener(
			ISimpleDialogListener simpleDialogListener) {
		this.simpleDialogListener = simpleDialogListener;
	}

	public void setSimpleDialogCancelListener(
			ISimpleDialogCancelListener simpleDialogCancelListener) {
		this.simpleDialogCancelListener = simpleDialogCancelListener;
	}
	...
	protected ISimpleDialogListener getDialogListener() {
		if (this.simpleDialogListener != null) {
	...
	protected ISimpleDialogCancelListener getCancelListener() {
		if (this.simpleDialogCancelListener != null)
			return this.simpleDialogCancelListener;
		final Fragment targetFragment = getTargetFragment();
		if (targetFragment != null) {
